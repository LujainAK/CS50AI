...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        for c in cells:
            ...
            #Cell is already a move made
            elif c in self.moves_made:
                updatedCells.remove(c)
        cells = updatedCells
            ...
            for set1 in self.knowledge:
                for set2 in self.knowledge:
                    ...
                    if set1.cells.issubset(set2.cells):
                        inferredSet = set2.cells - set1.cells
                        inferredCount = set2.count - set1.count

                        newSentence = Sentence(inferredSet, inferredCount)
